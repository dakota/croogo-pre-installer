    ...
    }(function ($)
    {
        ...
        $.ajaxq = function (qname, opts)
        {
            ...
            if (typeof opts === "undefined") {
                throw (
                    "AjaxQ: queue name is not provided"
                );
            }
        ...
        $.each(["getq", "postq"], function (i, method)
        {
            $[method] = function (qname, url, data, callback, type)
            {
                ...
                return $.ajaxq(qname, {
                    type: method === "postq" ? "post" : "get", url: url, data: data, success: callback, dataType: type
                });
            };
        });
        ...
        {
            return (
                queues.hasOwnProperty(qname) && queues[qname].length > 0
                ) || activeReqs.hasOwnProperty(qname);
        };
